...
[CausalBench: Towards Better Causal Reasoning in Language Models](https://arxiv.org/abs/2410.16676) \\
...
## 📝 Published
- ``NAACL 2025 (main)`` [CausalBench: Towards Better Causal Reasoning in Language Models](https://arxiv.org/abs/2410.16676) Longxuan Yu\*, Delin Chen\*, **Siheng Xiong\***, Qingyang Wu, Qingzhen Liu, Dawei Li, Zhikai Chen, Xiaoze Liu, Liangming Pan [[Repo]](https://github.com/chendl02/Awesome-LLM-Causal-Reasoning)
